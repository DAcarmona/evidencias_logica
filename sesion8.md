...
```
```
2. public class ContadorVocales {

    public static int contarVocales(String cadena) {
        int contador = 0;
        cadena = cadena.toLowerCase(); // Convertir la cadena a minúsculas para que coincida con las vocales
...
```
```
3. public class CambiarMayusculasYMinusculas {

    public static String cambiarMayusculasYMinusculas(String cadena) {
        ...
        for (int i = 0; i < cadena.length(); i++) {
            ...
            if (Character.isUpperCase(caracter)) {
                ...
                resultado.append(caracter); // Mantener otros caracteres sin cambios
            }
        }
    ...
    public static void main(String[] args) {
        ...
        String textoCambiado = cambiarMayusculasYMinusculas(texto);
...
public class OrdenarPalabras {
    ...
    public static String ordenarPalabrasAlfabeticamente(String cadena) {
    ...
    public static void main(String[] args) {
        String texto = "manzana naranja pera uva banana";
